...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "logs/QA_2/"  # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = ["dataset/training_data/QA_2/QA_2/train/540x540_80x80/"]
        self.valid_dir_list = ["dataset/training_data/QA_2/QA_2/valid/540x540_80x80/"]
        ...
        module = importlib.import_module("inference.models.%s.opt" % model_name)
