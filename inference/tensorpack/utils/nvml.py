    ...
    def load(self):
        with self._lib_lock:
            if self._nvmlLib is None:
                ...
                self.func_ptr = {
                    n: self._function_pointer(n) for n in function_pointers
                }
...
class NvidiaDevice(object):
    ...
    def utilization(self):
        ...
        _check_return(
            _NVML.get_function("nvmlDeviceGetUtilizationRates")(self.hnd, byref(c_util))
        )
...
class NVMLContext(object):
    ...
    def num_devices(self):
        ...
        c_count = c_uint()
        _check_return(_NVML.get_function("nvmlDeviceGetCount_v2")(byref(c_count)))
    ...
    def device(self, idx):
        ...
        _check_return(
            _NVML.get_function("nvmlDeviceGetHandleByIndex_v2")(c_index, byref(device))
        )
